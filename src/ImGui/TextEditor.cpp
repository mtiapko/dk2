...
#include "dk/ImGui/imgui.h" // for imGui::GetCurrentWindow()
#undef ImGui
...
void TextEditor::Render()
{
	...
	if (!mLines.empty())
	{
		...
		const auto a = ImGui::GetMousePos();
		const auto b = ImVec2(a.x + 5, a.y + 5);
		if (ImGui::IsMousePosValid() && ImGui::IsRectVisible(a, b))
		{
